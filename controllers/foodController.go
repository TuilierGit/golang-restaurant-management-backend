...
func GetFoods() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		result, err := foodCollection.Aggregate(ctxWithTimeout, mongo.Pipeline{
		...
		var allFoods []bson.M
		if err = result.All(ctxWithTimeout, &allFoods); err != nil {
			log.Fatal(err)
		}
...
func GetFood() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		err := foodCollection.FindOne(ctxWithTimeout, bson.M{"food_id": foodId}).Decode(&food)
		if err != nil {
